...
<div class="container">
    ...
    <div class="row mb-2">
        <div class="col-md-3 offset-md-9">
            <form action="{{route('agenda.deleteallarchived')}}", method="POST">
                @csrf
                @method('delete')
                <button type="submit" class="btn btn-danger px-3" onclick="return confirm('Weet je zeker dat je alle gearchiveerde agendapunten wilt verwijderen? Deze actie kan niet ongedaan worden');">Verwijder alle gearchiveerde agendapunten</button>
            </form>
        </div>
    </div>
    @endif
